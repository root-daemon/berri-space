...
export default function SharedPage() {
  ...
  return (
    <>
      <AppHeader breadcrumbs={[{ label: 'My Drive', href: '/drive' }, { label: 'Shared with Me' }]} />
      
      <div className="flex-1 overflow-auto">
        <div className="p-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-4xl font-500 text-foreground tracking-tight">Shared with Me</h1>
              <p className="text-sm text-muted-foreground mt-2 font-400">
                Files and folders shared by your team
              </p>
            </div>
            <Button
