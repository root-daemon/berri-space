-- Fix the inheritance loop logic - don't check inherit_permissions inside the loop
-- Only the initial resource's inherit_permissions flag matters
...
COMMENT ON FUNCTION get_effective_role IS 'Effective role on resource. Inheritance walks up entire parent chain without checking intermediate inherit_permissions flags.';
